...
FAKE_ATTR_WITH_REGION = {:region => "REGION", :city => "CITY", :postalcode => 12345, :street => "STREET", :recipient => "MR. X"}
FAKE_ATTR_WO_REGION = {:city => "CITY", :postalcode => 12345, :street => "STREET", :recipient => "MR. X"}
